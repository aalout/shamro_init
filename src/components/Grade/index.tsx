...
export default function Grade() {
  const educationData = [
    ...
    { year: 2025, text: "Сексология в психологическом консультировании. (600 ч.)" },
    { year: 2026, text: "Сексология — повышение квалификации." },
    { year: 2026, text: "Дополнительное образование «Психоанализ, психоаналитическая психотерапия и психоаналитическое консультирование в практике психолога» (950 ч.)" },
  ];

  return (
    <div id='grade' className={styles.grade}>
